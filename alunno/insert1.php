...
function insert_alunno(){
    if(isset($_POST['cf'])){
        ...
        if($query_res) echo "<div>Inserimento alunno avvenuto con successo</div><br><a href='index.php'>Torna alla pagina index per gli alunni.";
        else echo "<div>Inserimento alunno fallito</div><br><a href='index.php'>Torna alla pagina index per gli alunni.";
    }
    else echo "<div>'Inserimento alunno fallito</div><br><a href='index.php'>Torna alla pagina index per gli alunni.";
}
insert_alunno();
