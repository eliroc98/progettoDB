...
function edit_scuola(){
    if(isset($_POST['codice'])&&isset($_POST['nome'])&&isset($_POST['indirizzo'])){
        ...
        if($result==TRUE) echo "<div>Modifica scuola avvenuta con successo</div><br><a href='index.php'>Torna alla pagina index per le scuole.";
        else echo "<div>'Modifica scuola fallita</div><br><a href='index.php'>Torna alla pagina index per le scuole.";
    }
    else echo "<div>'Modifica scuola fallita</div><br><a href='index.php'>Torna alla pagina index per le scuole.";
}
edit_scuola();
